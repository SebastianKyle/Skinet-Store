...
const routes: Routes = [
  ...
  { path: 'contact', 
    loadChildren: () => import('./contact/contact.module').then(mod => mod.ContactModule), data: { breadcrumb: 'Contact Us' } },
  { path: 'test-error', component: TestErrorComponent, data: { breadcrumb: 'Tests errors' } },
